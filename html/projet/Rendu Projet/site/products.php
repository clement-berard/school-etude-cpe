<?php
/**
 * dans cette page, on affiche tous les produits disponibles
 * On peut les ajouter au panier ou alors voir la fiche du produit
 */
        ...
        <?php foreach ($lesproduitspromo as $k => $v): ?>
            <div class="item_product">
                <div class="image">
                    ...
                    <?php } else { ?>
                        <img src="assets/images/noimage220.gif" alt="<?php echo $v['title'] ?>" >
                    <?php } ?>
                </div>
                <div class="infos">
